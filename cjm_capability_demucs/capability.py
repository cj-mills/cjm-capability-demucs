...
Docs: https://cj-mills.github.io/cjm-capability-demucscapability.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/capability.ipynb.

# %% auto #0
__all__ = ['DemucsCapabilityConfig', 'DemucsProcessingCapability']

# %% ../nbs/capability.ipynb #exports-imports
import logging
...
# %% ../nbs/capability.ipynb #config-dataclass
@dataclass
...
# %% ../nbs/capability.ipynb #capability-class
...
# %% ../nbs/capability.ipynb #m-store-job
@patch
...
# %% ../nbs/capability.ipynb #m-separate-vocals
@patch
